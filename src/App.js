...
function Model({ url }) {
  ...
  return (
    <group rotation={[-Math.PI / 2, 0, 0]} position={[0, -7, 0]} scale={[6, 6, 6]}>
...
export default function App() {
  return (
    <>
      ...
      <div className="layer" />
      <Loading />
      <a href="https://github.com/DevMiguell?tab=repositories" className="top-left" target="_blank" children="Github" />
      <a href="https://github.com/drcmda/react-three-fiber" className="bottom-left" target="_blank" children="+ react-three-fiber" />
    </>
  )
}
